/*
  SmartPark — ESP32-CAM Exit Gate Controller (HYBRID: stream + trigger)
  =====================================================================

  Hardware: ESP32-CAM AI-Thinker  •  Sensor kamera: OV3660 (atau OV2640)
  Role    : Kamera + controller untuk gate KELUAR
...
// Device identity (exit gate)
const char* DEVICE_ID = "esp32cam-gate-exit-1";
...
void setup() {
  Serial.begin(115200);
  Serial.println("\n========================================");
  Serial.println("  SmartPark — Exit Gate Controller");
...
static esp_err_t stream_handler(httpd_req_t* req) {
  ...
  while (true) {
    ...
    delay(40);                 // ~20-25 fps cap, keeps AI-Thinker responsive
  }
  return res;
}
